    ...
    <div className="animate-fade-up pt-24">
      ...
      <div className="mx-auto max-w-5xl px-4 sm:px-5">
        ...
        >
          <Image
            src="/banner.png"
            alt="BOLOBET — A sua melhor jogada começa aqui. Copa do Mundo 2026"
            width={1536}
            height={1024}
            priority
      ...
      <section className="mx-auto max-w-3xl px-5 pt-8 text-center">
        ...
        <div className="mt-8 grid grid-cols-3 gap-3">
          {statCards.map(({ num, label, icon: Icon }) => (
            <div
              key={label}
              className="group rounded-2xl border border-border bg-card p-4 transition-all duration-300 hover:border-primary/50 hover:shadow-lg hover:shadow-primary/10"
            >
      ...
      <section className="mx-auto max-w-3xl px-5 pb-10 pt-10">
        ...
        <p className="mt-6 text-center text-xs leading-relaxed text-muted-foreground/80">
          ...
          apostar, você concorda com essas condições.
        </p>
      </section>
    </div>
  )
